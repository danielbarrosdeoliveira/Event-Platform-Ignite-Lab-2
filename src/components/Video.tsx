    ...
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                alt={`Imagem do Instrutor ${data.lesson.teacher.name}`}
              />
        ...
        <section className="gap-8 mt-20 grid grid-cols-2">
          <a
            href=""
            className="bg-gray-700 rouded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transitions-colors"
          >
